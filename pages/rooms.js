      ...
      <section className="flex flex-row border-b-2 border-gray-200">
        <div className="w-3/4 border-r-2 border-gray-200 pr-6 pb-10">
            <div className="w-full py-6">
                Testing this thing : <button className="btn-primary">Room 1</button>
                <button className="btn-primary">Room 1</button>
            </div>
        ...
        <div className="w-1/4 pl-6">
            ...
            <div className="w-full mt-6 py-4 px-6 bg-gray-200 rounded-lg">
